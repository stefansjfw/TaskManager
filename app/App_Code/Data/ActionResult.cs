...
namespace StefanTutorialDemo.Data
{
    public class ActionResult
    {
        ...
        public void ShowViewMessage(string format, params object[] args)
        {
        ...
        public void Focus(string fieldName, string fmt, params object[] args)
        {
        ...
        public void ExecuteOnClient(string javaScriptFormatString, params object[] args)
        {
        ...
        public void ShowAlert(string fmt, params object[] args)
        {
        ...
        {
            ExecuteOnClient("if(this._container&&this.get_controller()=='{0}'){{this._savePosition();this._showModal({{commandName:'{2}',commandArgument:'{3}'}});}}else Web.DataView.showModal(null, '{0}', '{1}', '{2}', '{3}');", controller, view, startCommandName, startCommandArgument);
        }
        ...
        public FieldValue Add(string name, object value)
        {
            var result = new FieldValue(name, value);
            Values.Add(result);
            return result;
        }
    }
