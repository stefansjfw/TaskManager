...
namespace StefanTutorialDemo.Data
{
    public class ConnectionStringSettingsFactoryBase
    {
        ...
        protected virtual ConnectionStringSettings CreateSettings(string connectionStringName)
        {
            if (string.IsNullOrEmpty(connectionStringName))
                connectionStringName = "StefanTutorialDemo";
    ...
    public class SqlText : SqlStatement
    {
        ...
        public static SqlText Create(string text, string connectionStringName, params object[] args)
        {
        ...
        public static object ExecuteScalar(string text, params object[] args)
        {
            return ExecuteScalar(text, string.Empty, args);
        }

        public static object ExecuteScalar(string text, string connectionStringName, params object[] args)
        {
            using (var sel = Create(text, connectionStringName, args))
                return sel.ExecuteScalar();
        }

        public static int ExecuteNonQuery(string text, params object[] args)
        {
            return ExecuteNonQuery(text, string.Empty, args);
        }

        public static int ExecuteNonQuery(string text, string connectionStringName, params object[] args)
        {
            using (var sel = Create(text, connectionStringName, args))
                return sel.ExecuteNonQuery();
        }

        public static object[] Execute(string text, params object[] args)
        {
            return Execute(text, string.Empty, args);
        }

        public static object[] Execute(string text, string connectionStringName, params object[] args)
        {
            using (var sel = Create(text, connectionStringName, args))
                if (sel.Read())
                {
