...
namespace StefanTutorialDemo.Handlers
{
    ...
    public class ReportBase : GenericHandlerBase, IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private ActionArgs _executeArgs;
        ...
        void IHttpHandler.ProcessRequest(HttpContext context)
        {
            ...
            var args = this.ExecuteArgs;
            if ((args == null) && !string.IsNullOrEmpty(aa))
            ...
            reportTemplate = _validationKeyRegex.Replace(reportTemplate, string.Format("/Blob.ashx?_validationKey={0}&amp;", TextUtility.ToMD5Hash(ApplicationServices.ValidationKey)));
        ...
        /// <param name="args">A collection of parameters that control the report generation.</param>
        /// <returns>A binary array representing the report data.</returns>
        public static byte[] Execute(ReportArgs args, ActionArgs executeArgs)
        {
            ...
            var reportHandler = ((ReportBase)(ApplicationServices.CreateInstance("StefanTutorialDemo.Handlers.Report")));
            reportHandler.OutputStream = output;
            reportHandler.Arguments = args;
            reportHandler.Request = request;
            reportHandler.ExecuteArgs = executeArgs;
            if (args.Filter != null)
            {
        ...
        protected virtual string ToReportFormat(string format)
        {
        ...
        protected virtual string ToReportDefinition(string reportTemplate)
        {
