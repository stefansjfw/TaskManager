...
namespace StefanTutorialDemo.Services
{
        ...
        public static string ValidationKey
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(key) || key.Contains("AutoGenerate"))
                    key = "2430FEDBCCCD2F797F917CA5C78209E5CE90AD65A780228C15468E742C3B6A48FDFCB02946F8BB6F7CC03CA6D175851526B1373DADC70EACEDF6089592115D13";
                return key;
            }
        }
    ...
    public partial class ApplicationServicesBase
    {
        ...
        {
            StefanTutorialDemo.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            if (AuthorizationIsSupported)
            {
                ...
                if (Membership.GetUser("admin") == null)
                {
                    ...
                    admin = Membership.CreateUser("admin", "admin123%", "admin@StefanTutorialDemo.com", "ASP.NET", "Code OnTime", true, out status);
                    user = Membership.CreateUser("user", "user123%", "user@StefanTutorialDemo.com", "ASP.NET", "Code OnTime", true, out status);
                    offline = Membership.CreateUser("offline", "offline123%", "offline@StefanTutorialDemo.com", "ASP.NET", "Code OnTime", true, out status);
