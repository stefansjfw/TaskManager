...
namespace StefanTutorialDemo.Web.Design
{
    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                var res = GetType().Assembly.GetManifestResourceStream(string.Format("StefanTutorialDemo.Controllers.{0}.xml", DataController));
                if (res == null)
                    res = GetType().Assembly.GetManifestResourceStream(string.Format("StefanTutorialDemo.{0}.xml", DataController));
                if (res != null)
    ...
    public class DataViewDesignSchema : IDataSourceViewSchema
    {
        ...
        IDataSourceFieldSchema[] IDataSourceViewSchema.GetFields()
        {
            ...
            if (_view != null)
            {
                ...
                var systemFieldIterator = _view.Select(string.Format("//a:field[not(@name=//a:view[@id='{0}']//a:dataField/@fieldName) and @isPrimaryKey='true']", _view.GetAttribute("id", string.Empty)), _nm);
