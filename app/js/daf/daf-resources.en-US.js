...
(function () {
    ...
    _dvr.Mobile = {
        ...
        Generate: 'Generate',
        Wait: 'Please wait...',
        RemainingSec: 'NNNN sec remaining',
        RemainingMin: 'NNNN min remaining',
        Scan: 'Scan',
        ScanHint: 'Enter or scan a barcode',
        ScanInvMode: 'Inventory Mode',
        Send: 'Send',
        InlineCommands: {
            List: {
                Select: 'Select Item',
    ...
    _dvr.ODP = {
        ...
        UnableToDelete: 'Unable to delete. Reason: {1} items in {0}.',
        ...
        Rec: 'Reconciliation',
        RecRequired: 'Reconciliation is required.',
        RecTxDelete: 'Delete this change from the log.',
        RecTxDeleted: 'Deleted the first pending transaction in the log.',
        Tx: 'Transaction',
        Action: 'Action',
        ...
        Done: 'Done.',
        LogoutWarning: 'Account data will be deleted from this device. Continue?',
        Duration: 'Duration',
        DurationSec: 'NNNN sec',
        DurationMin: 'NNNN min'
    ...
    _dvr.OAuth2 = {
        ...
        Connect: 'XXXXX by YYYYY would like to connect to your account.',
        SignedInAs: 'Signed in as',
        SwitchAccount: 'Switch Account',
        Continue: 'Continue',
        UseAnotherAccount: 'Use another account',
        ChooseAccMsg: 'Choose an account to continue to XXXXX',
        WantsTo: 'XXXX wants to',
        Scopes: {
            profile: 'XXXX wants to know your last and first name, birthdate, gender, picture, and preferred language',
            email: 'XXXX wants to view your email address',
            address: 'XXXX wants to view your preferred postal address',
            phone: 'XXXX wants to view your phone number',
            offline_access: 'XXXX wants to access your data anytime'
        },
        ConnectDevice: 'Connect a Device',
        ReturnToDevice: 'Return to your device to continue.',
        EnterUserCode: 'Enter the code displayed on your device',
        InvalidDeviceCode: 'This device code is not valid.'
    };

    _dvr.PWA = {
        Install: 'Install',
        InstallApp: 'Install XXXXX app.',
        DoNotPrompt: 'Do not prompt in the future.'
    };
