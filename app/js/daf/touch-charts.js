    ...
    (function () {
        ...
        $(document).on('resizing.app', function () {
            ...
            .on('vclick', '.app-chart', function (event) {
                ...
                if (target.is('.app-btn-more') && !_app.touch.busy()) {
                    _app.touch.callWithFeedback(target.closest('.ui-btn'), function () {
            ...
            move: function (drag) {
                ...
                switch (calendar.mode) {
                    ...
                    case 'week':
                        ...
                        break;
                    case 'month':
                        var dayCell = $(drag.dropTarget).closest('td'),
                            month = dayCell.closest('.app-calendar-month');
