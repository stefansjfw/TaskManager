...
* Copyright 2018-2023 Code On Time LLC; Licensed MIT; http://codeontime.com/license
*/
    ...
    _edit = _touch.edit = {
        ...
        move: function (options) {
            ...
            switch (direction) {
                case 'pageup':
                case 'pagedown':
                    summaryView = findScrollable().trigger('focus').find('.app-focus[data-input="dataview"]');
        ...
        toggleBool: function (elem, dataView) {
            ...
            if (allowEdit) {
                ...
                _app.execute({ command: 'Update', in: dataView, values: values/*[{ field: field.Name, value: boolValue, newValue: newBoolValue }]*/ }).then(function (result) {
                    dataView.sync();
