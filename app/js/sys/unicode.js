...
(function () {
    ...
    _unicode.C = _unicode.Cc
        + _unicode.Cf
        + _unicode.Cs
        + _unicode.Co;
    //+ _unicode.Cn ; //This is not defined.

    _unicode.L = _unicode.Lu
        + _unicode.Ll
        + _unicode.Lt
        + _unicode.Lm
        + _unicode.Mn    //Added 2014-05-29 due to some letters in names not being recognized.
        //This is where accent marks are individually combined instead of using an explicit character.
        + _unicode.Lo;

    _unicode.LC = _unicode.Lu
        + _unicode.Ll
        + _unicode.Lt;

    _unicode.M = _unicode.Mn
        + _unicode.Mc
        + _unicode.Me;

    _unicode.N = _unicode.Nd
        + _unicode.Nl
        + _unicode.No;

    _unicode.P = _unicode.Pc
        + _unicode.Pd
        + _unicode.Ps
        + _unicode.Pe
        + _unicode.Pi
    ...
    _unicode.S = _unicode.Sm
        + _unicode.Sc
        + _unicode.Sk
        + _unicode.So;

    _unicode.Z = _unicode.Zs
        + _unicode.Zl
        + _unicode.Zp;
    ...
    _unicode.b = '(?:[' + _unicode.w + '](?:[^' + _unicode.w + ']|$)'
        + '|(?:^|[^' + _unicode.w + '])[' + _unicode.w + ']'
        + ')';

    //A Unicode based word boundry build with non-capturing parentheses
    _unicode.bOut = '(?=[^' + _unicode.w + ']|$)';
    ...
    _unicode.d = _unicode.N;
    //_unicode.uppercaseRegex = new RegExp("[" + _unicode.Lu + "]", "");
    //_unicode.lowercaseRegex = new RegExp("[" + _unicode.Ll + "]", "");
    //_unicode.titlecaseRegex = new RegExp("[" + _unicode.Lt + "]", "");
    //_unicode.wordCharRegex = new RegExp("[" + _unicode.w + "]", "");
    //_unicode.nonWordCharRegex = new RegExp("[^" + _unicode.w + "]", "");
    //_unicode.letterAndSpaceRegEx = new RegExp("[^" + _unicode.L + _unicode.Zs + "]", "");
})();