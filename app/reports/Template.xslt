...
If you can see this message, then you need to install the correct version of the Microsoft RDL Designer:
* Microsoft RDL Report Designer for Visual Studio 2022: https://marketplace.visualstudio.com/items?itemName=ProBITools.MicrosoftReportProjectsforVisualStudio2022&ssr=false#overview
* Microsoft RDL Report Designer for Visual Studio 2017-2019: https://marketplace.visualstudio.com/items?itemName=ProBITools.MicrosoftRdlcReportDesignerforVisualStudio-18001
